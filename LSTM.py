...
Description: This program uses an artificial recurrent neural network called Long Short Term Memory
             to predict closing stock price using past 60 day stock prices.
"""
...
#Get the stock quote
df = web.DataReader('USO', data_source='yahoo', start='2001-11-01', end='2020-04-20')
...
#Plot the data
train = data[-120:training_data_len]
